...
import type { CursorChatEvent, TimerEvent, VoteEvent } from '@/lib/facilitation';
...
declare global {
  interface Liveblocks {
    ...
    RoomEvent: ReactionEvent | CommentsChangedEvent | TimerEvent | CursorChatEvent | VoteEvent;
  }
}
